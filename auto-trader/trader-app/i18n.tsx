...
const DICTIONARY = {
  ...
  mexcUnavailable: { nl: 'MEXC-gegevens niet beschikbaar', en: 'MEXC data unavailable' },
  mexcPositionsUnavailable: {
    nl: 'Open MEXC-posities zijn niet beschikbaar zolang de exchange-read mislukt.',
    en: 'Open MEXC positions are unavailable while the exchange read is failing.',
  },
