...
echo "=========================================="
echo ""
echo "1. Om direct te testen in de terminal:"
echo "   bit run trader-platform"
echo ""
echo "2. Om 24/7 op de achtergrond te draaien:"
echo "   pm2 start \"bit run trader-platform\" --name \"trader-bot\""
echo "   pm2 save"
echo "   pm2 startup"
echo ""
echo "3. Open het dashboard vanaf je eigen computer op hetzelfde netwerk:"
echo "   http://$(hostname -I | awk '{print $1}'):3000"
echo "   of: http://raspberrypi.local:3000"
echo "=========================================="